...
public class ExtentTest {
	...
	public void endReport(){
		...
		//flush() - to write or update test information to your report. 
           ...
           //     information missing), this 
//method will ensure that the test is still appended to the report with a warning message.
                //You should call close() only once, at the very end (in @AfterSuite for example) as
